...
const messages = {
    en: {
        ...
        resetToPreContestState: 'Reset to Pre-Contest State',
        confirmResetPreContestState: 'This will reset all rounds to draft, reset scores to default, clear advancement logs, and clear advancement-dependent slots to TBD. Continue?',
    ...
    zh: {
        ...
        saveTournament: '儲存賽事',
        resetToPreContestState: '重設為賽前狀態',
        confirmResetPreContestState: '此操作將把所有回合重設為草稿、分數重設為預設值、清空晉級日誌，並將受晉級規則控制的槽位清為待定。是否繼續？',
